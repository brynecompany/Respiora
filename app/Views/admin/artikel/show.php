...
<div class="card border-0 shadow-sm p-4" style="border-radius:18px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 px-2"
        ...
        <div class="d-flex align-items-center gap-2 mt-3">
            ...
            <div id="toggleSwitch"
                class="mini-switch <?= $artikel['status_artikel'] === 'Publish' ? 'active' : '' ?>"
                onclick="toggleStatus(<?= $artikel['id_artikel']; ?>)">
                <div class="mini-circle"></div>
            </div>

            <span>
                Status :
                <strong id="statusText"><?= $artikel['status_artikel']; ?></strong>
            </span>
...
document.getElementById("statusSwitch").addEventListener("click", function() {
    ...
    fetch("<?= base_url('admin/artikel/toggleStatus') ?>/" + artikelId)
