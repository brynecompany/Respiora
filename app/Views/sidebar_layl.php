...
<body>
    <div class="sidebar">
        <div class="logo text-center">
            <img src="<?= base_url('assets/images/logo_respiora.png') ?>" alt="Logo RESPIORA" style="max-width: 160px; height: auto;">
        </div>
        ...
        <a href="<?= base_url('profil') ?>"> <i class="fa-regular fa-user me-2"></i> Profil</a>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="profile-box mx-auto">    
            ...
            <div class="fw-bold mb-3 text-start">
            ...
            <button class="btn btn-dark-blue w-100">Ubah Kata Sandi</button>
        </div>
        </div>  
        <?php endif; ?>
        </div>
