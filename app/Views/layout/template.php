...
<head>
    ...
    <?= $this->renderSection('style'); ?> <!--punya Mira -->
</head>
<body>
    <div class="sidebar">
        <div class="logo text-center">
            <img src="/assets/img/logo_nama.svg" alt="Logo RESPIORA" style="max-width: 160px; height: auto;">
        </div>
        ...
        <a href="/peta_view" class="<?= ($menu == 'petasebaran') ? 'active' : '' ?>"><i class="fa-solid fa-map me-2"></i> Peta Sebaran</a> <!--tambahin $menu-->
    ...
    <?= $this->renderSection('script'); ?> <!--punya Mira-->
</body>
</html>