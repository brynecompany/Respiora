...
<html>
<head>
    <title>Respiora Kepala Puskesmas</title>
...
<div class="sidebar">
    ...
    <a href="<?= base_url('kapus/artikel') ?>"
       class="<?= str_contains(uri_string(),'kapus/artikel') ? 'active' : '' ?>">
        <i class="bi bi-journal-text"></i>Artikel
    </a>

    <a href="<?= base_url('kapus/berita') ?>" 
        class="sidebar-link <?= uri_string() == 'kapus/berita' ? 'active' : '' ?>">
...
<div class="topbar">
    ...
    <div class="d-flex align-items-center">
        <div class="text-end me-3">
            ...
            <small style="color:#888;">Kepala Puskesmas</small>
        </div>

        <img src="<?= base_url('uploads/profile/kapus.jpg') ?>" class="avatar-img">
    </div>
